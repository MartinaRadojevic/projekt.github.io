<template>
  <div class="login">
    ...
    <div class="container">
      <div class="row">
        <div><img id="linije" src="@/assets/2.jpg"></div>
...
rezerviraj(){
firebase.firestore().collection("Karte").doc(this.userEmail).collection(this.userEmail).doc("2a").get().then(doc =>{
this.cijena=doc.data().Cijena;
this.kolicina=doc.data().Kolicina;
})

firebase.firestore().collection("Karte").doc(this.userEmail).collection(this.userEmail).doc("2a").set({
