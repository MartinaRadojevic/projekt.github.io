<template>
  <div class="login">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm">
            <router-link to="/gradskelinije"><button class="function">
          
            <span>+</span><span class="btn-text">GRADSKE LINIJE</span>
          
        </button>
        </router-link>
        <div class="col-sm">
             <router-link to="/prigradskelinije"><button class="function">
         
            <span>+</span><span class="btn-text">PRIGRADSKE LINIJE</span>
